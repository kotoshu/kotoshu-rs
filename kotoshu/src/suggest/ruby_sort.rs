...
mod tests {
    ...
    fn reproduces_ruby_sort_by_tie_order() {
        let fixtures: &[(Vec<i64>, Vec<usize>)] = &[
            ...
            (
                vec![
                    2, 1, 2, 3, 0, 1, 0, 1, 2, 1, 2, 1, 2, 1, 1, 1, 3, 0, 3, 3, 1, 2, 0, 0, 1,
                ],
                vec![
                    23, 22, 4, 6, 17, 24, 1, 5, 7, 9, 20, 11, 13, 14, 15, 21, 12, 10, 8, 2, 0, 16,
                    18, 19, 3,
                ],
            ),
            (
                ...
                vec![
                    48, 44, 41, 33, 31, 24, 22, 21, 20, 16, 15, 4, 5, 3, 42, 2, 10, 25, 34, 8, 6,
                    23, 28, 30, 35, 36, 37, 1, 46, 27, 11, 19, 18, 17, 12, 14, 0, 47, 45, 43, 13,
                    40, 39, 38, 9, 7, 32, 26, 29,
                ],
            ),
        ];
